...
function registerNativeHeuristics(context) {
    ...
    const js = [ '/js/scripting/native-heuristics.js' ];
...
function registerAutomation(context) {
    ...
    const js = [ '/js/scripting/automation.js' ];
...
function registerRemoteCosmetics(context) {
    ...
    const js = [ '/js/scripting/remote-cosmetics.js' ];
...
function registerPostHideCleanup(context) {
    ...
    const js = [ '/js/scripting/post-hide-cleanup.js' ];
